...
#define PACKET_EDITOR_MAJOR_VERSION 1
#define PACKET_EDITOR_MINOR_VERSION 0
#define PACKET_EDITOR_SERVICE_VERSION 0

#define PACKET_EDITOR_VERSION ( ((PACKET_EDITOR_MAJOR_VERSION) << (16)) | \
    ((PACKET_EDITOR_MINOR_VERSION) << (8))  |  \
    (PACKET_EDITOR_SERVICE_VERSION) )
